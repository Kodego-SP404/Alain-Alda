...
if (file_exists($file)) {
   ...
   $contents = 'William' . PHP_EOL . 'Jestoni' . PHP_EOL . 'Ryen' . PHP_EOL . 'Ryan';

   // fwrite () writes the contents to the file and returns the number of bytes written on succcess, or FALSE on failure.
